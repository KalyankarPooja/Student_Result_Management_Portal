...
public class adminHome extends javax.swing.JFrame {
    ...
    if (rs.next()) {
        // Roll number exists, prompt for update
        int option = JOptionPane.showConfirmDialog(null, "Roll number already exists. Do you want to update the existing record?", "Warning", JOptionPane.YES_NO_OPTION);
        if (option == JOptionPane.YES_OPTION) {
            // Update the existing record
            st.executeUpdate("UPDATE student SET course = '" + course + "', branchName = '" + branchName + "', name = '" + name + "', gender = '" + gender + "', fathername = '" + fathername + "' WHERE rollno = '" + rollno + "'");
            JOptionPane.showMessageDialog(null, "Data updated successfully");
            setVisible(false);
            new adminHome().setVisible(true);
        }
    } else {
        // Roll number does not exist, insert into table
