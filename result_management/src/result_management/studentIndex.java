...
public class studentIndex extends javax.swing.JFrame {
  ...
  public studentIndex(String rollno){
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/result_management/icons8-wrong-24.png"))); // NOI18N
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        String rollno=jTextField4.getText();
         ...
         if(rs.next()){
             ...
             int ss2=Integer.parseInt(jTextField8.getText());
             ...
             String totalmarks=String.valueOf(s1+ss2+s3+s4+s5);
